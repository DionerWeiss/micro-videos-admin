...
import { GenreCollectionPresenter } from 'src/nest-modules/genres-module/genres.presenter';
import { GENRES_PROVIDERS } from 'src/nest-modules/genres-module/genres.providers';
import {
  CreateGenreFixture,
  ListGenresFixture,
  UpdateGenreFixture,
} from 'src/nest-modules/genres-module/testing/genre-fixture';
  ...
  describe('should create a category', () => {
    ...
    test.each(arrange)(
      ...
      async ({ send_data, expected, relations }) => {
        ...
        const entity = await genreRepo.findById(new GenreId(presenter.id));
